...
/* Банковата сметка стои на едно място: показва се и в количката, и в писмото
   до клиента. Два записа биха се разминали при първата смяна на банка, а
   сгрешен IBAN в писмо означава загубени пари и обаждания. */
const AS_BANK = [
  'holder' => '"Лотус 9" ЕООД',
  'iban' => 'BG41FINV91501017882274',
  /* Толкова има клиентът да преведе, преди поръчката да се освободи. */
  'days' => 3,
];

/* Точната стойност, която пристига от формата при избран банков превод.
   Тя е българска на всички езици - влиза в писмото до магазина. */
const AS_PAY_BANK = 'Банков превод';
